...
// tax bands -- with thanks to http://www.oldmutual.co.za/markets/south-african-budget/income-tax-calculator
    ...
    expenditure : {
        'Economic Development' : 195.1 * 100,
        'General Public Service' : 70 * 100,
        'Debt-service costs' : 229.3 * 100,
        'Other learning and culture' : 65.9 * 100,
        'Health' : 229.7 * 100,
        'Community Development' : 212.3 * 100,
        'Other social development' : 68.3 * 100,
        'Basic Education' : 248.6 * 100,
        'University Transfers and NSFAS' : 81.9 * 100,
        'Social security funds' : 88.0 * 100,
        'Old-age grant' : 83.1 * 100,
        'Child-support grant' : 69.8 * 100,
        'Innovation, science and technology' : 16.4 * 100,
        'Police Services' : 106.1 * 100,
        'Defence and state security' : 51.4 * 100,
        'Law courts and prisons' :  49.6 * 100,
        'Home affairs' :  9.9 * 100,
